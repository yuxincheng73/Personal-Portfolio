  ...
  return (
    <div className="min-h-screen">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center py-20 relative">
        ...
        <div className="md:fixed relative -left-1 md:left-6 top-1/2 md:-translate-y-1/2 flex flex-col items-center">
          <div className="flex flex-col space-y-4 md:space-y-6">
            <div className="w-[1px] h-16 md:h-20 bg-slate-400 mx-auto"></div>
