        ...
        <div className="container mx-auto px-24">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-slate-400">
              Software Developer passionate about creating impactful solutions and delivering exceptional web experiences.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="min-h-screen flex items-center py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mb-4 text-slate-400">
              With years of experience in the field, I've worked on a variety of projects ranging from small business
